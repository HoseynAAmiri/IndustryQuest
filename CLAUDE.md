...
Skills live in `.claude/skills/<name>/SKILL.md`. When a skill applies, open that file and follow it for the rest of the turn. Do not work from the skill name or from memory.
