...
Last updated September 19, 2026. Marks sit in front of each requirement ID below and in the acceptance scenarios in Section 22. Implemented M rows are bold.
...
All 128 M requirements and all 22 critical pilot acceptance scenarios (Section 22.1) pass. AC-20 was checked with an automated WCAG 2.2 AA audit (axe) and a keyboard-only pass; a session with a real screen reader is still outstanding.
...
| [x] ACC-07 | **Staff and organization administrators use stronger authentication; session revocation and account recovery protect privileged access.** | M |
...
| [x] PRJ-02 | **Templates help authors write a bounded problem, learning outcomes, deliverables, milestones, and a review rubric.** | M |
...
| [x] WRK-08 | **External meeting links and calendar downloads support check-ins without requiring a built-in video service.** | M |
...
| [x] WRK-11 | **Approved pauses and revised deadlines are visible to all affected participants and suppress inappropriate overdue nudges.** | M |
...
| [x] WRK-15 | **Project closeout preserves accepted evidence, archives obsolete access, and explains retention and portfolio permissions.** | M |
...
| [x] MEN-04 | **A welcome template sets communication channels, response expectations, checkpoint dates, and escalation contact.** | M |
| [x] MEN-05 | **Mentor dashboard prioritizes unanswered questions, due checkpoints, pending reviews, and blocked students.** | M |
| [x] MEN-06 | **Private student feedback evaluates mentor clarity, responsiveness, usefulness, and respectful conduct.** | M |
...
| [x] ASM-06 | **Students evaluate project scope, resources, learning value, and mentor support through a separate feedback channel.** | M |
...
| [x] ASM-09 | **Conflicts of interest and reviewer substitutions are recorded; students can raise a concern without confronting the assessor publicly.** | M |
...
| [x] ORG-10 | **Partner quality review can limit new postings or suspend participation while protecting current students and their evidence.** | M |
...
| [x] NTF-10 | **Overdue rules account for approved pauses, holidays, revised deadlines, and an assigned backup reviewer.** | M |
...
| [x] OPS-04 | **Blocking or contact restrictions prevent unwanted direct communication while preserving a supported reassignment path for active projects.** | M |
...
| [x] OPS-06 | **Skill names, aliases, rubric templates, and credential rules are curated and versioned through restricted tools.** | M |
...
| [x] OPS-08 | **Help pages cover getting started, project expectations, assessment, sharing permissions, and common account issues.** | M |
...
| [x] OPS-10 | **Retention, export, deletion, and access requests have a documented operations process and accountable owner.** | M |
